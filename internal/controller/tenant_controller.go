...
func (r *TenantReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &cloudkitv1alpha1.Tenant{}
...
func (r *TenantReconciler) handleUpdate(ctx context.Context, req ctrl.Request, instance *cloudkitv1alpha1.Tenant) (ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)
	...
	instance.Status.Phase = cloudkitv1alpha1.TenantPhaseProgressing

	// Create namespace
	if err := r.createOrUpdateTenantNamespace(ctx, instance); err != nil {
		instance.Status.Phase = cloudkitv1alpha1.TenantPhaseFailed
		return ctrl.Result{}, err
	}
	...
	instance.Status.Phase = cloudkitv1alpha1.TenantPhaseReady

	return ctrl.Result{}, nil
}

// handleDelete handles deletion operations for Tenant
func (r *TenantReconciler) handleDelete(ctx context.Context, req ctrl.Request, instance *cloudkitv1alpha1.Tenant) (ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)
	log.Info("handling delete for Tenant", "name", instance.Name)

	// Set deleting phase
	instance.Status.Phase = cloudkitv1alpha1.TenantPhaseDeleting
...
func (r *TenantReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudkitv1alpha1.Tenant{}, builder.WithPredicates(tenantNamespacePredicate(r.tenantNamespace))).
		Named("tenant").
		Watches(
			&corev1.Namespace{},
